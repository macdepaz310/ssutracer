...
<html>
  <head>
    <title>SSU Trace: Survey Question 1</title>
          ...
          <div class="container">
             ...
             <div class="collapse navbar-collapse" id="myNavbar">
               <ul class="nav navbar-nav">
                 <li class="active"><a href="survey-question-1.php">Take A Survey</a></li>
  ...
  <div class="">
    ...
    if(isset($_POST['submit'])):
      ...
      if($stmt->execute() && $_POST['ans']=='yes' ):
        header('Location: ../survey-question/survey-question-2.php');
      elseif($stmt->execute() && $_POST['ans']=='no' ):
          header('Location: ../survey-question/survey-question-8.php');
      else:
        echo "sorry";
      endif;
    endif;
    ?>
    <form class="form-horizontal" action="survey-question-1.php" method="post">
        <div class="radio">
          <label for="yes"><input type="radio" id="yes" name="ans" value="yes" required>Yes</label>
        </div>
        <div class="radio">
          <label for="no"><input type="radio" id="no" name="ans" value="no" required>No</label>
        </div><br>
...
<footer class="container">
            <h2>SSU Tracer</h2><p>All Right Reserved &copy; 2017 Samar State University Information System and Information Technology Tracer</p>
</footer>
  </body>
</html>
