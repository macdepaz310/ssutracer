...
<html>
  <head>
    <title>SSU Trace: Survey Question 10</title>
          ...
          <div class="container">
             ...
             <div class="collapse navbar-collapse" id="myNavbar">
               <ul class="nav navbar-nav">
                 <li class="active"><a href="survey-question-10.php">Take A Survey</a></li>
...
<div class="well">
  <div class="">
    ...
    try {
       ...
       $stmt = $conn->prepare("SELECT questionText FROM question_tbl where questionID=10");
       $stmt->execute();
    ...
    if(isset($_POST['submit'])):
      ...
      if($stmt->execute() ):
        header('Refresh: 0.2; url= ../survey-question/survey-question-19.php');
      else:
        echo "sorry";
      endif;
    endif;
    ?>
    <form class="form-horizontal" action="survey-question-10.php" method="post">
      <div class="radio">
        <label for="q10" >Ex.(Ex. Grade school teacher, Electrical Engineer, Self-employed)</label>
          <input type="text" name="ans" id="q10" class="form-control" required autofocus>
      </div><br>
