...
<html>
  <head>
    <title>SSU Trace: Survey Question 12</title>
          ...
          <div class="container">
             ...
             <div class="collapse navbar-collapse" id="myNavbar">
               <ul class="nav navbar-nav">
                 <li class="active"><a href="survey-question-12.php">Take A Survey</a></li>
...
<div class="well">
  <div class="">
    ...
    try {
       ...
       $stmt = $conn->prepare("SELECT questionText FROM question_tbl where questionID=12");
       $stmt->execute();
    ...
    if(isset($_POST['submit'])):
      ...
      if($stmt->execute() && $_POST['ans']=='Yes' ):
        header('Location: ../survey-question/survey-question-13.php');
      elseif($stmt->execute() && $_POST['ans']=='No' ):
        header('Location: ../survey-question/survey-question-15.php');
      else:
        echo "sorry";
      endif;
    endif;
    ?>
    <form class="form-horizontal" action="survey-question-12.php" method="post">
      <div class="radio">
