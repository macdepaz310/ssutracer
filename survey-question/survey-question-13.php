...
<html>
  <head>
    <title>SSU Trace: Survey Question 13</title>
          ...
          <div class="container">
             ...
             <div class="collapse navbar-collapse" id="myNavbar">
               <ul class="nav navbar-nav">
                 <li class="active"><a href="survey-question-13.php">Take A Survey</a></li>
...
<div class="well">
  <div class="">
    ...
    ?>
    <form class="form-horizontal" action="survey-question-13.php" method="post">
      <div class="checkbox">
      ...
      <div class="checkbox">
        <label for="Related to Special Skill"><input type="checkbox" id="Related to Special Skill" name="ans2" value="Related to Special Skill" >Related to Special Skill</label>
      </div>
      <div class="checkbox">
        <label for="Related to Course or Program of Study"><input type="checkbox" id="Related to Course or Program of Study" name="ans3" value="Related to Course or Program of Study" >Related to Course or Program of Study</label>
      </div>
      <div class="checkbox">
        <label for="Proximity to Residence"><input type="checkbox" id="Proximity to Residence" name="ans4" value="Proximity to Residence" >Proximity to Residence</label>
      </div>
      <div class="checkbox">
        <label for="Peer Influence"><input type="checkbox" id="Peer Influence" name="ans5" value="Peer Influence" >Peer Influence</label>
      </div>
      <div class="checkbox">
        <label for="Family Influence"><input type="checkbox" id="Family Influence" name="ans5" value="Family Influence" >Family Influence</label>
      </div>
      <div class="checkbox">
        <label for="other reason(s)"><input type="checkbox" id="other reason(s)" name="ans6" value="other reason(s)" >other reason(s)</label>
      </div><br>
