...
<html>
  <head>
    <title>SSU Trace: Survey Question 14</title>
          ...
          <div class="container">
             ...
             <div class="collapse navbar-collapse" id="myNavbar">
               <ul class="nav navbar-nav">
                 <li class="active"><a href="survey-question-14.php">Take A Survey</a></li>
...
<div class="well">
  <div class="">
    ...
    if(isset($_POST['submit']) && !empty($_POST['ans'])):
      ...
      if($stmt->execute() ):
         header('Refresh: 0.2; url= ../survey-question/survey-question-15.php');
      else:
        echo "sorry";
      endif;
    endif;
