...
<html>
  <head>
    <title>SSU Trace: Survey Question 16</title>
          ...
          <div class="container">
             ...
             <div class="collapse navbar-collapse" id="myNavbar">
               <ul class="nav navbar-nav">
                 <li class="active"><a href="survey-question-16.php">Take A Survey</a></li>
...
<div class="well">
  <div class="">
    ...
    if(isset($_POST['submit'])):
      ...
      if($stmt->execute() ):
        header('Refresh:0.2; url= ../survey-question/survey-question-7.php');
      else:
        echo "sorry";
      endif;
    endif;
    ?>
    <form class="form-horizontal" action="survey-question-7.php" method="post">
      <div class="radio">
        <label for="Less than a month"><input type="radio" id="Less than a month" name="ans" value="Less than a month" required>Less than a month</label>
      </div>
      <div class="radio">
        <label for="1 to 7 months"><input type="radio" id="1 to 7 months" name="ans" value="1 to 7 months" required>1 to 7 months</label>
      </div>
      <div class="radio">
        <label for="7 to 11 months"><input type="radio" id="7 to 11 months" name="ans" value="7 to 11 months" required>7 to 11 months</label>
      </div>
      <div class="radio">
        <label for="1 year to less than 2 years"><input type="radio" id="1 year to less than 2 years" name="ans" value="1 year to less than 2 years" required>1 year to less than 2 years</label>
      </div>
      <div class="radio">
        <label for="2 years to less than 3 years"><input type="radio" id="2 years to less than 3 years" name="ans" value="2 years to less than 3 years" required>2 years to less than 3 years</label>
      </div>
      <div class="radio">
        <label for="3 years to less than 5 years"><input type="radio" id="3 years to less than 5 years" name="ans" value="3 years to less than 5 years" required>3 years to less than 5 years</label>
      </div><br>
