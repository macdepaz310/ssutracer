...
<html>
  <head>
    <title>SSU Trace: Survey Question 18</title>
          ...
          <div class="container">
             ...
             <div class="collapse navbar-collapse" id="myNavbar">
               <ul class="nav navbar-nav">
                 <li class="active"><a href="survey-question-18.php">Take A Survey</a></li>
...
<div class="well">
  <div class="">
    ...
    <form class="form-horizontal" action="survey-question-15.php" method="post">
      <div class="checkbox">
        <label for="Communication skills"><input type="checkbox" id="Communication skills" name="ans" value="Communication skills" >Communication skills</label>
      </div>
      <div class="checkbox">
        <label for="Human Relation skills"><input type="checkbox" id="Human Relation skills" name="ans1" value="Career Challenge" >Human Relation skills</label>
      </div>
      <div class="checkbox">
        <label for="Entrepreneurial skills"><input type="checkbox" id="Entrepreneurial skills" name="ans2" value="Entrepreneurial skills" >Entrepreneurial skills</label>
      </div>
      <div class="checkbox">
        <label for="Information Technology skills"><input type="checkbox" id="Information Technology skills" name="ans3" value="Information Technology skills" >Information Technology skills</label>
      </div>
      <div class="checkbox">
        <label for="Problem-solving skills"><input type="checkbox" id="Problem-solving skills" name="ans4" value="Problem-solving skills" >Problem-solving skills</label>
      </div>
      <div class="checkbox">
        <label for="other reason(s)"><input type="checkbox" id="other reason(s)" name="ans5" value="other reason(s)" >other reason(s)</label>
      </div><br>
