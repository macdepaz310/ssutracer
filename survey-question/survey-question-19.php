...
<html>
  <head>
    <title>SSU Trace: Survey Question 19</title>
          ...
          <div class="container">
             ...
             <div class="collapse navbar-collapse" id="myNavbar">
               <ul class="nav navbar-nav">
                 <li class="active"><a href="survey-question-19.php">Take A Survey</a></li>
...
<div class="well">
  <div class="">
    ...
    if(isset($_POST['submit'])):
      ...
      if($stmt->execute() ):
        header('Refresh: 0.2; url= ../survey-question/survey-question-11.php');
      else:
        echo "sorry";
      endif;
    endif;
    ?>
    <form class="form-horizontal" action="survey-question-19.php" method="post">
      <div class="radio">
        <label for="q19">(Ex. Samar State University, Arteche Blvd., Guindapunan Catbalogan City, Samar)</label>
        <input type="text" id="q19" class="form-control" name="ans" required autofocus>
      </div><br>
