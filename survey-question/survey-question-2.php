...
<html>
  <head>
    <meta charset="utf-8">
    <title>SSU Trace: Survey Question 2</title>
          ...
          <div class="container">
             ...
             <div class="collapse navbar-collapse" id="myNavbar">
               <ul class="nav navbar-nav">
                 <li class="active"><a href="survey-question-2.php">Take A Survey</a></li>
  ...
  <div class="">
    ...
    if(isset($_POST['submit'])):
      ...
      if($stmt->execute() && $_POST['ans']=='Self-Employed' ):
        header('Location: ../survey-question/survey-question-9.php');
      elseif($stmt->execute() ):
            header('Location: ../survey-question/survey-question-10.php');
      else:
        echo "sorry";
      endif;
    endif;
    ?>
    <form class="form-horizontal" action="survey-question-2.php" method="post">
        <div class="radio">
          <br><label for="regular"><input type="radio" id="regular" name="ans" value="Regular" required>Regular</label>
        </div>
        <div class="radio">
          <label for="casual"><input type="radio" id="casual" name="ans" value="Casual" required>Casual</label>
        </div>
        <div class="radio">
          <label for="Temporary"><input type="radio" id="Temporary" name="ans" value="Temporary" required>Temporary</label>
        </div>
        <div class="radio">
          <label for="Contractual"><input type="radio" id="Contractual" name="ans" value="Contractual" required>Contractual</label>
        </div>
        <div class="radio">
          <label for="Self-Employed"><input type="radio" id="Self-Employed" name="ans" value="Self-Employed" required>Self-Employed</label>
        </div>
