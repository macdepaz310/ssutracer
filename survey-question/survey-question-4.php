...
<html>
  <head>
    <title>SSU Trace: Survey Question 4</title>
          ...
          <div class="container">
             ...
             <div class="collapse navbar-collapse" id="myNavbar">
               <ul class="nav navbar-nav">
                 <li class="active"><a href="survey-question-4.php">Take A Survey</a></li>
...
<div class="well">
  <div class="">
    ...
    if(isset($_POST['submit'])):
      ...
      if($stmt->execute() ):
        header('Location: ../survey-question/survey-question-5.php');
      else:
        echo "sorry";
      endif;
    endif;
    ?>
    <form class="form-horizontal" action="survey-question-4.php" method="post">
        <div class="radio">
          <br><label for="walkInApplicant"><input type="radio" id="walkInApplicant" name="ans" value="walkInApplicant" required>Walk In Applicant</label>
        </div>
        <div class="radio">
          <label for="responseToAdvertisement"><input type="radio" id="responseToAdvertisement" name="ans" value="responseToAdvertisement" required>Response To Advertisement</label>
        </div>
        <div class="radio">
          <label for="recommendedBySomeone"><input type="radio" id="recommendedBySomeone" name="ans" value="recommendedBySomeone" required>Recommended By Someone</label>
        </div>
        <div class="radio">
          <label for="familyBusiness"><input type="radio" id="familyBusiness" name="ans" value="familyBusiness" required>Family Business</label>
        </div>
        <div class="radio">
          <label for="arrangeBytheSchoolOrJobPlacementOffer"><input type="radio" id="arrangeBytheSchoolOrJobPlacementOffer" name="ans" value="arrangeBytheSchoolOrJobPlacementOffer" required>Arrange by the school or job placement offer</label>
        </div>
        <div class="radio">
          <label for="jobFairOrPublicEmploymentServiceOffice"><input type="radio" id="jobFairOrPublicEmploymentServiceOffice" name="ans" value="jobFairOrPublicEmploymentServiceOffice" required>Job Fair or public employement service office</label>
        </div>
