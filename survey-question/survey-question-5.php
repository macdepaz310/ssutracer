...
<html>
  <head>
    <title>SSU Trace: Survey Question 5</title>
          ...
          <div class="container">
             ...
             <div class="collapse navbar-collapse" id="myNavbar">
               <ul class="nav navbar-nav">
                 <li class="active"><a href="survey-question-5.php">Take A Survey</a></li>
...
<div class="well">
  <div class="">
    ...
    if(isset($_POST['submit'])):
      ...
      if($stmt->execute() ):
        header('Refresh:0.2; url= ../survey-question/survey-question-6.php');
      else:
        echo "sorry";
      endif;
    endif;
    ?>
    <form class="form-horizontal" action="survey-question-5.php" method="post">
        <div class="radio">
          <br><label for="1-5mos"><input type="radio" id="1-5mos" name="ans" value="1-5mos" required>1-5months</label>
        </div>
        <div class="radio">
          <label for="5-11mos"><input type="radio" id="5-11mos" name="ans" value="5-11mos" required>5-11months</label>
        </div>
        <div class="radio">
          <label for="1-2years"><input type="radio" id="1-2years" name="ans" value="1-2years" required>1-2years</label>
        </div>
        <div class="radio">
          <label for="2-3years"><input type="radio" id="2-3years" name="ans" value="2-3years" required>2-3years</label>
        </div>
        <div class="radio">
          <label for="3-5years"><input type="radio" id="3-5years" name="ans" value="3-5years" required>3-5years</label>
        </div>
