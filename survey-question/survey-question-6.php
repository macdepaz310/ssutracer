...
<html>
  <head>
    <title>SSU Trace: Survey Question 6</title>
          ...
          <div class="container">
             ...
             <div class="collapse navbar-collapse" id="myNavbar">
               <ul class="nav navbar-nav">
                 <li class="active"><a href="survey-question-6.php">Take A Survey</a></li>
...
<div class="well">
  <div class="">
    ...
    if(isset($_POST['submit'])):
      ...
      if($stmt->execute() ):
        header('Refresh:0.2; url= ../survey-question/survey-question-3.php');
      else:
        echo "sorry";
      endif;
    endif;
    ?>
    <form class="form-horizontal" action="survey-question-6.php" method="post">
        <div class="radio">
          <br><label for="rank/clerical"><input type="radio" id="rank/clerical" name="ans" value="rank/clerical" required>Rank/Clerical</label>
        </div>
        <div class="radio">
          <label for="professional/advisory"><input type="radio" id="professional/advisory" name="ans" value="professional/advisory" required>Professional/Advisory</label>
        </div>
        <div class="radio">
          <label for="managerial/executive"><input type="radio" id="managerial/executive" name="ans" value="managerial/executive" required>Managerial/Executive</label>
        </div>
        <div class="radio">
