...
<html>
  <head>
    <title>SSU Trace: Survey Question 7</title>
          ...
          <div class="container">
             ...
             <div class="collapse navbar-collapse" id="myNavbar">
               <ul class="nav navbar-nav">
                 <li class="active"><a href="survey-question-7.php">Take A Survey</a></li>
...
<div class="well">
  <div class="">
    ...
    try {
       ...
       $stmt = $conn->prepare("SELECT questionText FROM question_tbl where questionID=7");
       $stmt->execute();
    ...
    if(isset($_POST['submit'])):
      ...
      if($stmt->execute()):
        header('Refresh:0.2; url= ../survey-question/survey-question-14.php');
      else:
        echo "sorry";
      endif;
    endif;
