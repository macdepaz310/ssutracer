...
<html>
  <head>
    <title>SSU Trace: Survey Question 8</title>
          ...
          <div class="container">
             ...
             <div class="collapse navbar-collapse" id="myNavbar">
               <ul class="nav navbar-nav">
                 <li class="active"><a href="survey-question-8.php">Take A Survey</a></li>
...
<div class="well">
  <div class="">
    ...
    ?>
    <form class="form-horizontal" action="survey-question-8.php" method="post">
      <div class="checkbox">
        <label for="Advanced or further study"><input type="checkbox" id="Advanced or further study" name="ans1" value="Advanced or further study" >Advanced or further study</label>
      </div>
      <div class="checkbox">
        <label for="Health-related reason"><input type="checkbox" id="Health-related reason" name="ans2" value="Health-related reason" >Health-related reason</label>
      </div>
      <div class="checkbox">
        <label for="Lack of work experience"><input type="checkbox" id="Lack of work experience" name="ans3" value="Lack of work experience" >Lack of work experience</label>
      </div>
      <div class="checkbox">
        <label for="No job opportunity"><input type="checkbox" id="No job opportunity" name="ans4" value="No job opportunity" >No job opportunity</label>
      </div>
      <div class="checkbox">
        <label for="did not look for a job"><input type="checkbox" id="did not look for a job" name="ans5" value="did not look for a job" >Did not look for a job</label>
      </div>
      <div class="checkbox">
