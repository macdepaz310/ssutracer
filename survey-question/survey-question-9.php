...
<html>
  <head>
    <title>SSU Trace: Survey Question 9</title>
          ...
          <div class="container">
             ...
             <div class="collapse navbar-collapse" id="myNavbar">
               <ul class="nav navbar-nav">
                 <li class="active"><a href="survey-question-9.php">Take A Survey</a></li>
...
<div class="well">
  <div class="">
    ...
    try {
       ...
       $stmt = $conn->prepare("SELECT questionText FROM question_tbl where questionID=9");
       $stmt->execute();
    ...
    if(isset($_POST['submit'])):
      ...
      if($stmt->execute() ):
        header('Refresh:0.2; url= ../survey-question/survey-question-10.php');
      else:
        echo "sorry";
      endif;
    endif;
    ?>
    <form class="form-horizontal" action="survey-question-9.php" method="post">
      <div class="radio">
        <label for="Parents"><input type="radio" id="Parents" name="ans" value="Parents" required>Parents</label>
      </div>
      <div class="radio">
        <label for="Friend/Relatives"><input type="radio" id="Friend/Relatives" name="ans" value="Friend/Relatives" required>Friend/Relatives</label>
      </div>
      <div class="radio">
        <label for="Government Program"><input type="radio" id="Government Program" name="ans" value="Government Program" required>Government Program</label>
      </div>
      <div class="radio">
        <label for="Financial Institution"><input type="radio" id="Financial Institution" name="ans" value="Financial Institution" required>Financial Institution</label>
      </div><br>
