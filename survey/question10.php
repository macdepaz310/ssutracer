...
if(isset($_POST['submit'])):
  ...
  if($stmt->execute() ):
    header('Refresh: 0.2; url= ../survey/question19.php');
  else:
    echo "sorry";
  endif;
endif;
...
<html>
  ...
  <body>
    <form class="" action="question10.php" method="post">
      Ex.(Ex. Grade school teacher, Electrical Engineer, Self-employed) <br>
