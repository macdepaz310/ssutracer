...
<html>
  ...
  <body>
    <form class="" action="question2.php" method="post">
      <input type="radio" name="ans" value="Regular" required>Regular<br>
      <input type="radio" name="ans" value="Casual" required>Casual<br>
      <input type="radio" name="ans" value="Temporary" required>Temporary<br>
      <input type="radio" name="ans" value="Contractual" required>Contractual<br>
