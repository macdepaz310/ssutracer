...
<html>
  ...
  <body>
    <form class="" action="question9.php" method="post">
      <input type="radio" name="ans" value="Parents" required>Parents<br>
      <input type="radio" name="ans" value="Friend/Relatives" required>Friend/Relatives<br>
      <input type="radio" name="ans" value="Government Program" required>Government Program<br>
      <input type="radio" name="ans" value="Financial Institution" required>Financial Institution<br>
