...
<div class="well col-sm-9 bg-white">
  <div class="table-responsive">
    ...
    if(isset($_POST['submit'])):
      ...
      if($stmt->execute() ):
        header('Refresh:0.2; url= ../surveyQuestion/surveyQ4.php');
      else:
        echo "sorry";
      endif;
    endif;
    ...
    <html>
      ...
      <body> -->
        <form class="form-horizontal" action="surveyQ3.php" method="post">
          <div class="radio">
            <label for=""><input type="radio" name="ans" value="<8k" required>8,000 below</label>
          </div>
          <div class="radio">
            <label for=""><input type="radio" name="ans" value="8k-15k" required>8,000-15,000</label>
          </div>
          <div class="radio">
            <label for=""><input type="radio" name="ans" value="15k-25k" required>15,000-25,000</label>
          </div>
          <div class="radio">
            <label for=""><input type="radio" name="ans" value=">25k" required>25,000 above</label>
          </div>
          <br>
