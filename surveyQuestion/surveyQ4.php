...
<div class="well col-sm-9 bg-white">
  <div class="table-responsive">
    ...
    if(isset($_POST['submit'])):
      ...
      if($stmt->execute() ):
        header('Refresh:0.2; url= ../surveyQuestion/surveyQ5.php');
      else:
        echo "sorry";
      endif;
    endif;
    ...
    <html>
      ...
      <body>
        <form class="form-horizontal" action="surveyQ4.php" method="post">
          <div class="radio">
            <label for=""><input type="radio" name="ans" value="walkInApplicant" required>Walk in applicant</label>
          </div>
          <div class="radio">
            <label for=""><input type="radio" name="ans" value="responseToAdvertisement" required>Response to advertisement</label>
          </div>
          <div class="radio">
            <label for=""><input type="radio" name="ans" value="recommendedBySomeone" required>Recommended by someone</label>
          </div>
          <div class="radio">
            <label for=""><input type="radio" name="ans" value="familyBusiness" required>Family business</label>
          </div>
          <div class="radio">
            <label for=""><input type="radio" name="ans" value="arrangeBytheSchoolOrJobPlacementOffer" required>Arrange by the school or job placement offer</label>
          </div>
          <div class="radio">
            <label for=""><input type="radio" name="ans" value="jobFairOrPublicEmploymentServiceOffice" required>Job Fair or public employement service office</label>
          </div>
          <br>
