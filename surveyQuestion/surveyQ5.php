...
<div class="well col-sm-9 bg-white">
  <div class="table-responsive">
    ...
    if(isset($_POST['submit'])):
      ...
      if($stmt->execute() ):
        header('Refresh:0.2; url= ../surveyQuestion/surveyQ6.php');
      else:
        echo "sorry";
      endif;
    endif;
    ...
    <html>
      ...
      <body>
        <form class="form-horizontal" action="surveyQ5.php" method="post">
          ...
          <div class="radio">
            <label for=""><input type="radio" name="ans" value="5-11mos" required>5-11months</label>
          </div>
          <div class="radio">
            <label for=""><input type="radio" name="ans" value="1-2years" required>1-2years</label>
          </div>
          <div class="radio">
            <label for=""><input type="radio" name="ans" value="2-3years" required>2-3years</label>
          </div>
          <div class="radio">
            <label for=""><input type="radio" name="ans" value="3-5years" required>3-5years</label>
          </div>
          <br>
