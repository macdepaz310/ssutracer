...
<div class="well col-sm-9 bg-white">
  <div class="table-responsive">
    ...
    if(isset($_POST['submit'])):
      ...
      if($stmt->execute() ):
        header('Refresh:0.2; url= ../surveyQuestion/surveyQ7.php');
      else:
        echo "sorry";
      endif;
    endif;
    ...
    <html>
      ...
      <body>
        <form class="form-horizontal" action="surveyQ6.php" method="post">
          <div class="radio">
            <label for=""><input type="radio" name="ans" value="rank/clerical" required>Rank/Clerical</label>
          </div>
          <div class="radio">
            <label for=""><input type="radio" name="ans" value="professional/advisory" required>Professional/Advisory</label>
          </div>
          <div class="radio">
            <label for=""><input type="radio" name="ans" value="managerial/executive" required>Managerial/Executive</label>
          </div>
          <div class="radio">
            <label for=""><input type="radio" name="ans" value="self-employed" required>Self-Employed<br></label>
          </div>
          <br>
