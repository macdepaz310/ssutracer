          ...
          <div class="carousel-inner">
            <div class="item active">
              <div class="chart-container-fluid">
                  <canvas class="item" id="ISchartQuestion1"></canvas>
              </div>
            </div>
            <div class="item" >
              <div class="chart-container-fluid">
                  <canvas class="item" id="ISchartQuestion2"></canvas>
              </div>
            </div>
            <div class="item" >
              <div class="chart-container-fluid">
                  <canvas class="item" id="ISchartQuestion3"></canvas>
              </div>
            </div>
            <div class="item" >
              <div class="chart-container-fluid">
                  <canvas class="item" id="ISchartQuestion4"></canvas>
              </div>
            </div>
            <div class="item" >
              <div class="chart-container-fluid">
                  <canvas class="item" id="ISchartQuestion5"></canvas>
              </div>
            </div>
            <div class="item" >
              <div class="chart-container-fluid">
                  <canvas class="item" id="ISchartQuestion6"></canvas>
              </div>
            </div>
            <div class="item" >
              <div class="chart-container-fluid">
                  <canvas class="item" id="ISchartQuestion7"></canvas>
              </div>
            </div>
...
<script src="../charts/js/BSIScharts/BSISQ2chart.js"></script>
<script src="../charts/js/BSIScharts/BSISQ3chart.js"></script>
<script src="../charts/js/BSIScharts/BSISQ4chart.js"></script>
<script src="../charts/js/BSIScharts/BSISQ5chart.js"></script>
<script src="../charts/js/BSIScharts/BSISQ6chart.js"></script>
